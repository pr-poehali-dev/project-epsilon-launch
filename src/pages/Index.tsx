        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          >
            ...
            <div className="flex-1 p-2">
              <div className="mb-4">
                ...
                <div className="mt-1 space-y-0.5">
                  {["общий", "новости", "стримы", "поддержка"].map((channel) => (
                    <div
                      key={channel}
              ...
              <div>
                ...
                <div className="mt-1 space-y-0.5">
                  {["Лаунж", "Совместный стрим", "Радио 24/7"].map((channel) => (
                    <div
                      key={channel}
                      className="flex items-center gap-1.5 px-2 py-1 rounded text-[#8e9297] hover:text-[#dcddde] hover:bg-[#393c43] cursor-pointer"
                    >
            ...
            <div className="p-2 bg-[#292b2f] flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-white text-sm font-medium truncate">Стример</div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-white font-semibold">стримы</span>
              <div className="w-px h-6 bg-[#40444b] mx-2 hidden sm:block"></div>
              <span className="text-[#8e9297] text-sm hidden sm:block">Транслируй экран, общайся голосом и слушай радио вместе</span>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    ...
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      ...
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        ...
                        <li>📻 Встроенное радио — десятки станций на любой вкус</li>
                        <li>👥 Совместный просмотр для нескольких участников</li>
              ...
              {/* Сообщение пользователя с активностью стрима */}
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">Артём_стример</span>
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Начинаю стрим! Заходите смотреть — показываю новую игру 🎮
                  </div>

                  {/* Демо Rich Presence — стрим */}
                  <div className="bg-[#2f3136] border border-[#202225] rounded-lg overflow-hidden w-full max-w-sm">
                    ...
                    <div className="h-16 sm:h-20 bg-gradient-to-r from-[#5865f2] to-[#7c3aed] relative">
                      <div className="absolute -bottom-3 sm:-bottom-4 left-3 sm:left-4">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 border-[#2f3136] bg-[#36393f] overflow-hidden relative">
                          ...
                          <div className="absolute -bottom-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 bg-[#ed4245] border-4 border-[#2f3136] rounded-full flex items-center justify-center">
                    ...
                    <div className="pt-4 sm:pt-6 px-3 sm:px-4 pb-3 sm:pb-4">
                      <div className="mb-3 sm:mb-4">
                        <h3 className="text-white text-lg sm:text-xl font-bold mb-1">Артём</h3>
                        <div className="flex items-center gap-2 text-[#b9bbbe] text-xs sm:text-sm">
                          <span>artem_stream</span>
                          <span>·</span>
                          <span className="text-[#ed4245] font-medium">🔴 В ЭФИРЕ</span>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          {/* Иконка стрима */}
                          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#5865f2] to-[#eb459e] rounded-lg flex items-center justify-center flex-shrink-0">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-[#ed4245] rounded-full animate-pulse"></div>
                              <span className="text-[#ed4245] text-xs font-medium">1:23:07 в эфире</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    ...
                    <span className="text-[#72767d] text-xs hidden sm:inline">Сегодня в 12:42</span>
                  </div>
                  <div className="text-[#dcddde] text-sm sm:text-base mb-3">
                    Включила радио в канале, заходите слушать вместе 🎵
                  </div>
                  {/* Мини-плеер радио */}
                  <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-3 sm:p-4 max-w-sm">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-[#faa61a] to-[#ed4245] rounded-lg flex items-center justify-center flex-shrink-0">
                        <Radio className="w-5 h-5 text-white" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="text-white text-sm font-semibold truncate">Радио ENERGY</div>
                        <div className="text-[#b9bbbe] text-xs truncate">The Weeknd — Blinding Lights</div>
                      </div>
                      <Volume2 className="w-5 h-5 text-[#3ba55c] flex-shrink-0" />
                    </div>
                    <div className="mt-2 bg-[#40444b] rounded-full h-1">
                      <div className="bg-[#5865f2] h-1 rounded-full w-3/5"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="text-center">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Доступно для Windows, macOS и Linux</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Авторизация через OAuth — безопасно и быстро</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold text-sm sm:text-base">3</span>
                    </div>
                    <h3 className="text-white font-medium mb-2 text-sm sm:text-base">Транслируй!</h3>
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Запусти стрим, голосовой или включи радио</p>
                  </div>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: "1080p и 60fps без потери качества",
                    },
                    {
                      icon: <Mic className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Голосовые каналы",
                      desc: "Шумоподавление и эхоотмена встроены",
                    },
                    {
                      icon: <Radio className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Встроенное радио",
                      desc: "Десятки станций — слушайте вместе",
                    },
                    {
                      icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Безопасность",
                      desc: "Никакого сбора личных данных",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
            ...
            <div className="p-2 sm:p-4">
              <div className="bg-[#40444b] rounded-lg px-3 sm:px-4 py-2 sm:py-3">
                <div className="text-[#72767d] text-xs sm:text-sm">Сообщение #стримы</div>
              </div>
            </div>
          </div>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  {
                    name: "Артём_стример",
                    status: "🔴 Транслирует экран",
                    avatar: "А",
                    color: "from-purple-500 to-pink-500",
                  },
                  { name: "Катя", status: "📻 Слушает радио", avatar: "К", color: "from-green-500 to-teal-500" },
                  { name: "Дима", status: "🎙️ В голосовом", avatar: "Д", color: "from-blue-500 to-purple-500" },
                  { name: "Лена", status: "В сети", avatar: "Л", color: "from-orange-500 to-red-500" },
                ].map((user, index) => (
